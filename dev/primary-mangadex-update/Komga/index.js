...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Komga = exports.KomgaRequestInterceptor = exports.capitalize = exports.parseMangaStatus = exports.KomgaInfo = void 0;
    ...
    async getSourceMenu() {
        return Promise.resolve(createSection({
            ...
            rows: () => Promise.resolve([
                (0, KomgaSettings_1.serverSettingsMenu)(this.stateManager),
                (0, KomgaSettings_1.testServerSettingsMenu)(this.stateManager, this.requestManager),
                (0, KomgaSettings_1.resetSettingsButton)(this.stateManager)
            ])
        }));
    }
    async getTags() {
    ...
    async getHomePageSections(sectionCallback) {
        ...
        if (komgaAPI === null) {
            ...
            const section = createHomeSection({
                ...
                view_more: false,
                items: KomgaCommon_1.KomgaCommon.getServerUnavailableMangaTiles()
            });
...
},{"./KomgaCommon":51,"./KomgaSettings":52,"./Languages":53,"paperback-extensions-common":7}],51:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.KomgaCommon = void 0;
class KomgaCommon {
    static async searchRequest(searchQuery, metadata, requestManager, stateManager, page_size) {
        // This function is also called when the user search in an other source. It should not throw if the server is unavailable.
...
const retrieveStateData = async (stateManager) => {
...
const testServerSettings = async (stateManager, requestManager) => {
    ...
    const komgaAPI = await stateManager.retrieve('komgaAPI');
    const authorization = await stateManager.retrieve('authorization');
        ...
        form: createForm({
            onSubmit: (values) => {
                return Promise.all([
                    ...
                    stateManager.store('komgaAPI', (0, exports.createKomgaAPI)(values.serverAddress)),
                    stateManager.store('authorization', (0, exports.createAuthorizationString)(values.serverUsername, values.serverPassword)),
                ]).then();
            },
            validate: () => {
            ...
            sections: () => {
                return Promise.resolve([
                    ...
                    createSection({
                        ...
                        rows: () => {
                            return (0, exports.retrieveStateData)(stateManager).then(async (values) => {
                                return [
                                    createInputField({
                                        id: 'serverAddress',
                                        label: 'Server URL',
            ...
            sections: () => {
                return Promise.resolve([
                    createSection({
                        ...
                        rows: () => {
                            return (0, exports.testServerSettings)(stateManager, requestManager).then(async (value) => {
                                return [
                                    createLabel({
                                        label: value,
                                        value: '',
...
const resetSettingsButton = (stateManager) => {
    return createButton({
        ...
        onTap: () => {
            return Promise.all([
                stateManager.store('serverAddress', null),
                stateManager.store('serverUsername', null),
                stateManager.store('serverPassword', null),
                stateManager.store('authorization', null),
                stateManager.store('komgaAPI', null)
            ]).then();
        }
    });
};
