...
class MangaDex extends paperback_extensions_common_1.Source {
    ...
    getCustomListRequestURL(listId, ratings) {
        return __awaiter(this, void 0, void 0, function* () {
            const request = createRequestObject({
    ...
    getCoversMapping(mangaIds, ratings) {
        return __awaiter(this, void 0, void 0, function* () {
            const mapping = {};
            const request = createRequestObject({
            ...
            for (const manga of json.results) {
                ...
                const coverFileName = manga.data.relationships.filter((x) => x.type == 'cover_art').map((x) => { var _a; return (_a = x.attributes) === null || _a === void 0 ? void 0 : _a.fileName; })[0];
    ...
    getMangaDetails(mangaId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const coverFileName = json.data.relationships.filter((x) => x.type == 'cover_art').map((x) => { var _a; return (_a = x.attributes) === null || _a === void 0 ? void 0 : _a.fileName; })[0];
            let image;
            if (coverFileName) {
                image = `${this.COVER_BASE_URL}/${mangaId}/${coverFileName}${MangaDexHelper_1.MDImageQuality.getEnding(yield MangaDexSettings_1.getMangaThumbnail(this.stateManager))}`;
            }
            else {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (hasResults) {
                ...
                for (const chapter of json.results) {
                    ...
                    const group = chapter.data.relationships.filter((x) => x.type == 'scanlation_group').map((x) => x.attributes.name).join(', ');
    ...
    getSearchResults(query, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            results = yield MangaDexParser_1.parseMangaList(json.results, this, MangaDexSettings_1.getSearchThumbnail);
            ...
            const sections = [
                {
                    request: createRequestObject({
                        url: yield this.getCustomListRequestURL('a153b4e6-1fcc-4f45-a990-f37f989c0d74', ratings),
                        method: 'GET',
                    }),
                ...
                if (enabled_homepage_sections.includes(section.section.id)) {
                    ...
                    promises.push(this.requestManager.schedule(section.request, 1).then((response) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        switch (section.section.id) {
                            case 'latest_updates':
                                const coversMapping = yield this.getCoversMapping(json.results.map((x) => x.data.relationships.filter((x) => x.type == 'manga').map((x) => x.id)[0]), ratings);
                                section.section.items = yield MangaDexParser_1.parseChapterList(json.results, coversMapping, this, MangaDexSettings_1.getHomepageThumbnail, ratings);
                                break;
                            default:
                                section.section.items = yield MangaDexParser_1.parseMangaList(json.results, this, MangaDexSettings_1.getHomepageThumbnail);
                        }
                        sectionCallback(section.section);
                    })));
                }
                        ...
                        if (similarResponse.status !== 200) {
                            ...
                            if (similarJson.id === undefined) {
                                ...
                                if (similarJson.coverFileName === 'unknown') {
                                    ...
                                    image = `${COVER_BASE_URL}/${recommendedId}/${similarJson.coverFileName}${MangaDexHelper_1.MDImageQuality.getEnding(yield MangaDexSettings_1.getMangaThumbnail(this.stateManager))}`;
                                }
                                ...
                                for (const manga of similarJson.matches) {
                                    ...
                                    if (ratings.includes(manga.contentRating)) {
                                        ...
                                        if (manga.coverFileName === 'unknown') {
                                            ...
                                            image = `${COVER_BASE_URL}/${manga.id}/${manga.coverFileName}${MangaDexHelper_1.MDImageQuality.getEnding(yield MangaDexSettings_1.getMangaThumbnail(this.stateManager))}`;
                                        }
                                        results.push(createMangaTile({
                                            id: manga.id,
    ...
    getViewMoreItems(homepageSectionId, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (homepageSectionId) {
                case 'latest_updates':
                    const coversMapping = yield this.getCoversMapping(json.results.map((x) => x.data.relationships.filter((x) => x.type == 'manga').map((x) => x.id)[0]), ratings);
                    results = yield MangaDexParser_1.parseChapterList(json.results, coversMapping, this, MangaDexSettings_1.getHomepageThumbnail, ratings);
                    break;
                default:
                    results = yield MangaDexParser_1.parseMangaList(json.results, this, MangaDexSettings_1.getHomepageThumbnail);
            }
            return createPagedResults({
                results,
    ...
    filterUpdatedManga(mangaUpdatesFoundCallback, time, ids) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (loadNextPage) {
                ...
                const mangaToUpdate = [];
                for (const chapter of json.results) {
                    const mangaId = (_a = chapter.data.relationships.filter((x) => x.type == 'manga')[0]) === null || _a === void 0 ? void 0 : _a.id;
...
},{"./MangaDexHelper":57,"./MangaDexParser":58,"./MangaDexSettings":59,"./MangaDexSimilarManga":60,"./external/tag.json":61,"entities":5,"paperback-extensions-common":13}],57:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class MDContentRatingClass {
    ...
    getName(ratingEum) {
        var _a, _b;
        return (_b = (_a = this.Ratings.filter(Rating => Rating.enum == ratingEum)[0]) === null || _a === void 0 ? void 0 : _a.name) !== null && _b !== void 0 ? _b : '';
    }
    getDefault() {
...
const MangaDexHelper_1 = require("./MangaDexHelper");
const parseMangaList = (object, source, thumbnailSelector) => __awaiter(void 0, void 0, void 0, function* () {
    const results = [];
    for (const manga of object) {
        ...
        const coverFileName = manga.data.relationships.filter((x) => x.type == 'cover_art').map((x) => { var _a; return (_a = x.attributes) === null || _a === void 0 ? void 0 : _a.fileName; })[0];
        const image = coverFileName ? `${source.COVER_BASE_URL}/${mangaId}/${coverFileName}${MangaDexHelper_1.MDImageQuality.getEnding(yield thumbnailSelector(source.stateManager))}` : 'https://mangadex.org/_nuxt/img/cover-placeholder.d12c3c5.jpg';
        results.push(createMangaTile({
            id: mangaId,
...
const parseChapterList = (chapterObject, coversMapping, source, thumbnailSelector, ratings) => __awaiter(void 0, void 0, void 0, function* () {
    const results = [];
    for (const chapter of chapterObject) {
        const mangaId = chapter.data.relationships.filter((x) => x.type == 'manga').map((x) => x.id)[0];
        const title = chapter.data.relationships.filter((x) => x.type == 'manga').map((x) => x.attributes.title.en)[0];
        ...
        const image = coverFileName ? `${source.COVER_BASE_URL}/${mangaId}/${coverFileName}${MangaDexHelper_1.MDImageQuality.getEnding(yield thumbnailSelector(source.stateManager))}` : 'https://mangadex.org/_nuxt/img/cover-placeholder.d12c3c5.jpg';
        if (!mangaId || !title || !ratings.includes(chapter.data.relationships.filter((x) => x.type == 'manga').map((x) => x.attributes.contentRating)[0]))
            continue;
        results.push(createMangaTile({
            id: mangaId,
            title: createIconText({ text: title }),
...
},{"./MangaDexHelper":57}],59:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
const getRatings = (stateManager) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    return (_b = (yield stateManager.retrieve('ratings'))) !== null && _b !== void 0 ? _b : MangaDexHelper_1.MDRatings.getDefault();
});
                    ...
                    createSection({
                        ...
                        rows: () => {
                            return Promise.all([
                                ...
                                exports.getRatings(stateManager),
...
const getEnabledRecommendations = (stateManager) => __awaiter(void 0, void 0, void 0, function* () {
    var _h;
    return (_h = (yield stateManager.retrieve('enabled_recommendations'))) !== null && _h !== void 0 ? _h : false;
});
...
const getAmountRecommendations = (stateManager) => __awaiter(void 0, void 0, void 0, function* () {
    var _j;
    return (_j = (yield stateManager.retrieve('amount_of_recommendations'))) !== null && _j !== void 0 ? _j : 5;
});
...
},{"./MangaDexHelper":57,"./MangaDexSimilarManga":60}],60:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"./MangaDexSettings":59}],61:[function(require,module,exports){
