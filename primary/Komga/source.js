        ...
        return __awaiter(this, void 0, void 0, function* () {
            return Promise.resolve(createSection({
                ...
                rows: () => Promise.resolve([
                    KomgaSettings_1.serverSettingsMenu(this.stateManager),
                    KomgaSettings_1.testServerSettingsMenu(this.stateManager, this.requestManager),
                    KomgaSettings_1.resetSettingsButton(this.stateManager)
                ])
            }));
        });
    }
        ...
        form: createForm({
            onSubmit: (values) => {
                return Promise.all([
                    ...
                    stateManager.store('komgaAPI', exports.createKomgaAPI(values.serverAddress)),
                    stateManager.store('authorization', exports.createAuthorizationString(values.serverUsername, values.serverPassword)),
                ]).then();
            },
            validate: () => {
